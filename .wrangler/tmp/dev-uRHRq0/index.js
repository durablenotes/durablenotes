  ...
  async fetch(request, env) {
    ...
    if (url.pathname.startsWith("/api")) {
      if (url.pathname === "/api/settings" && request.method === "GET") {
        ...
        const config = settings.results.reduce((acc, curr) => {
...
// .wrangler/tmp/bundle-9ILbB2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-9ILbB2/middleware-loader.entry.ts
